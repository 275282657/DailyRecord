...
/**
 * 用于两个工作线程之间交换数据的封装工具类 简单说就是一个线程在完成一定的事务后想与另一个线程交换数据，则 *第一个先拿出数据的线程会一直等待第二个线程，直到第二个线程拿着数据到来时才能彼此交换对应数据
 *
 * @Author chenguopeng
    ...
    public static void main(String[] args) {
        ...
        new Thread(() -> {
            ...
            try {
                ...
                /**
                 * 如果这里睡200ms的话，应该是B线程先拿出数据，然后B线程等待A线程。因为是B先给的数据， 所以最后A线程会先拿到B给的数据，也就是先打印
                 */
